      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            // ===================== Start: Google Sign In Button Section =====================
            ElevatedButton.icon(
              onPressed: () async {
...
// ===================== End: Google Sign In Button Section =====================
          ],
        ),
      ),
    );
  ...
  // ===================== Start: Google Sign In Helper Method Section =====================
...
// ===================== End: Google Sign In Helper Method Section =====================
}
