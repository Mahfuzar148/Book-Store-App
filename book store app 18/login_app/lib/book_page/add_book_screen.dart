...
class _AddBookScreenState extends State<AddBookScreen> {
  ...
  final int _selectedIndex = 1; // Set initial selected index to 1 (Add Book)
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildPhoneField(
                      _ownersPhoneController, "Owner's Phone Number"),
                  ...
                  _buildTextField(
                      _publicationController, 'Publication', Icons.book_online),
                  ...
                  _image != null
                      ...
                      : Image.asset('assets/icons/book_icon.png', height: 100),

                  // Upload Book Image Button
                  ElevatedButton.icon(
                  ...
                  ElevatedButton.icon(
                    ...
                    icon: const FaIcon(FontAwesomeIcons.filePdf,
                        color: Colors.white),
                    label: const Text('Upload Book PDF',
                        style: TextStyle(color: Colors.white)),
                  ),
  ...
  // Helper method for phone field with consistent design
    ...
    return Container(
      ...
      child: IntlPhoneField(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: const TextStyle(color: Colors.grey),
          prefixIcon:
              const Icon(Icons.phone, color: Color.fromARGB(255, 12, 160, 59)),
          border: InputBorder.none,
          contentPadding:
              const EdgeInsets.symmetric(vertical: 15, horizontal: 15),
        ),
