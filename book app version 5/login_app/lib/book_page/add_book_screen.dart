...
import 'package:login_app/pdf_upload_and_view/pdf_upload_and_view.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Navigate to the UploadPdfScreen
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const MyPdfPage()),
                );
              }, // Call the upload method with context
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.grey,
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12)),
