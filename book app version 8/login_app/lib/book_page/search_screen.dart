            ...
            child: filteredBooks.isNotEmpty
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final phone = bookData['phone'] ??
                          '1234567890'; // Placeholder phone number
                      final whatsapp = bookData['whatsapp'] ??
                          '1234567890'; // Placeholder WhatsApp number
                      final telegram = bookData['telegram'] ??
                          'username'; // Placeholder Telegram username
